    ...
    <nav className="flex items-center justify-between p-4">
      ...
      <div className="hidden lg:block">
        <div className="flex space-x-4">
          ...
          <button onClick={onLoginClick} className="text-white bg-sky-900 hover:bg-white hover:text-sky-900 px-6 py-2 rounded-full text-lg font-semibold">Login</button>
        </div>
      </div>
    </nav>
  );
