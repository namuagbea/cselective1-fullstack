...
const AboutCard = () => {
    return ( 
            ...
            <div className="flex lg:w-[90vh] md:w-[60vh] sm:w-[40vh] bg-[#03ADE0] mb-24 sm:mb-16 justify-content-end float-end flex-row lg:mr-16 md:mr-12 sm:mr-10 text-[#FDFEFF] bg-opacity-80">
                <div className="lg:min-w-44 lg:p-4 lg:mt-[50px] md:mt-[70px] md:pr-2 sm:pr-2 sm:mt-[50px] right-2 text-right lg:text-[4vh] md:text-[3vh] md:min-w-40 sm:text-[2vh] sm:min-w-28 font-bold">
                    <span>About us</span>
                </div>
