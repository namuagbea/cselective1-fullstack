...
const AboutCard = () => {
    return ( 
            ...
            <div className="lg:min-w-44 lg:p-4 md:mt-12 md:pr-2 sm:pr-2 sm:mt-10 right-2 text-right lg:text-[4vh] md:text-[3vh] md:min-w-40 sm:text-[2vh] sm:min-w-28 font-bold">
                    <span>About us</span>
                </div>
